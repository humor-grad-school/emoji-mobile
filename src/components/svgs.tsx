...
export const categorySvgMap = {
  activity: Vue.component('svg-activity', {
    functional: true,
    render(h) {
      return <svg
  ...
  custom: Vue.component('svg-custom', {
    functional: true,
    render(h) {
      return <svg
        xmlns='http://www.w3.org/2000/svg'
  ...
  nature: Vue.component('svg-nature', {
    functional: true,
    render(h) {
      return <svg
        xmlns='http://www.w3.org/2000/svg'
  ...
  objects: Vue.component('svg-objects', {
    functional: true,
    render(h) {
      return <svg
        xmlns='http://www.w3.org/2000/svg'
  ...
  people: Vue.component('svg-people', {
    functional: true,
    render(h) {
      return <svg
        xmlns='http://www.w3.org/2000/svg'
  ...
  places: Vue.component('svg-places', {
    functional: true,
    render(h) {
      return <svg
        xmlns='http://www.w3.org/2000/svg'
  ...
  recent: Vue.component('svg-recent', {
    functional: true,
    render(h) {
      return <svg
        xmlns='http://www.w3.org/2000/svg'
  ...
  symbols: Vue.component('svg-symbols', {
    functional: true,
    render(h) {
      return <svg
        xmlns='http://www.w3.org/2000/svg'
